...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // Forward the APNs registration result to Capacitor. Without these, the
    // @capacitor/push-notifications plugin never receives the device token —
    // register() resolves but no 'registration'/'registrationError' event ever
    // fires, so device_tokens stays empty. This was the root cause of push
    // never working on iOS.
