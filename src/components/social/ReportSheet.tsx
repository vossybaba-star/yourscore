...
export function ReportSheet({ subjectType, subjectId, onClose }: {
  ...
  return (
    <Sheet onClose={onClose} labelledBy="report-sheet-title" variant="panel" border={LINE} maxHeight="80vh"
      padding="16px 16px calc(20px + env(safe-area-inset-bottom))">
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
        <div id="report-sheet-title" className="font-display" style={{ fontSize: 17, color: INK }}>Report</div>
