...
export function BottomNav() {
  ...
  const isChallenges = pathname.startsWith("/challenges") || pathname.startsWith("/h2h");
  ...
  return (
    ...
    >
      <div className="flex items-center justify-around max-w-lg mx-auto px-1 py-2">
        ...
        {/* Challenges */}
        <Link href="/challenges" className="flex flex-col items-center gap-1 px-3 py-1 transition-colors" style={{ color: isChallenges ? "#ffb800" : "#8888aa" }}>
          <svg width="21" height="21" viewBox="0 0 22 22" fill="none">
          ...
          <span className="font-body text-xs">Challenges</span>
        </Link>
