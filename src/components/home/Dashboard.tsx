      ...
      <div className="relative z-0 max-w-lg mx-auto px-5 space-y-5">
        ...
        <div className="dash-slide-4">
          <Link href="/38-0/play"
            ...
            style={{ background: "linear-gradient(135deg, rgba(0,255,135,0.16) 0%, rgba(0,255,135,0.06) 100%)", border: "1px solid rgba(0,255,135,0.35)", display: "flex" }}>
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
                style={{ background: "rgba(0,255,135,0.18)", border: "1px solid rgba(0,255,135,0.3)" }}>
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                  <path d="M8 2.5 3 5.5 5 9.5 7.3 8.3V19a1 1 0 0 0 1 1h5.4a1 1 0 0 0 1-1V8.3L17 9.5l2-4-5-3C14 4.4 12.7 5.6 11 5.6S8 4.4 8 2.5Z"
                    stroke="#00ff87" strokeWidth="1.7" strokeLinejoin="round" fill="rgba(0,255,135,0.15)"/>
                </svg>
              </div>
            ...
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" style={{ color: "#00ff87", flexShrink: 0 }}>
