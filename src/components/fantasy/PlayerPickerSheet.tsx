...
import { INK, LINE, MUTED, Sheet, PosTag, type Pos } from "@/components/fantasy/shared";
...
export function PlayerPickerSheet({ open, onClose, onSelect }: {
  ...
  return (
    <Sheet onClose={onClose} labelledBy="player-picker-title" variant="panel" layout="flex" height="75vh">
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 16px 10px", flexShrink: 0 }}>
        <span id="player-picker-title" className="font-display" style={{ fontSize: 17, color: INK }}>Attach a player</span>
      ...
      <div style={{ padding: "0 16px 10px", flexShrink: 0 }}>
        <input value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search by name or club"
          style={{
