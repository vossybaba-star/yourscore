...
// Who follows this manager — reached by tapping the "followers" count on a profile.
  ...
  return (
    <main className="min-h-dvh bg-bg pb-28">
      ...
      <div className="relative z-0 max-w-lg mx-auto px-5">
        ...
        <h1 className="font-display text-3xl text-white mb-4">Followers</h1>
        <FollowList query={`type=followers&userId=${params.userId}`} emptyText="No followers yet." />
      </div>
    </main>
  );
}
