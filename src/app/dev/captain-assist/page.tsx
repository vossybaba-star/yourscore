 ...
 *  anyone sees it. Not linked from anywhere and must be removed (or gated)
...
const base = {
  ...
  disclaimer: "Guidance, not a guaranteed best move. Captaincy is the only recommendation we have validated.",
};
