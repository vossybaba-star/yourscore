      ...
      <div className="max-w-lg mx-auto px-5 pt-10">
        ...
        {mode === "finding" && (
          <div className="mt-10 text-center">
            ...
            <p className="mt-5 font-semibold" style={{ color: "#e8e8f0" }}>Finding a live opponent…</p>
            <button onClick={cancelFind} className="mt-6 text-sm underline" style={{ color: "#8888aa" }}>Cancel</button>
          </div>
        )}
      </div>
    </div>
