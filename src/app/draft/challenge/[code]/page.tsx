...
/**
 * /draft/challenge/[code] — a friend opens a shared challenge: see the
...
export default function AcceptChallenge() {
  ...
  if (info.ready === false) return wrap(<div><div className="font-display tracking-wide" style={{ fontSize: 24, color: "#fff" }}>CHALLENGES COMING SOON</div><Link href="/draft" className="inline-block mt-4 font-body" style={{ color: "#00ff87" }}>← Build your XI</Link></div>);
  if (status === 404 || info.error === "Challenge not found") return wrap(<div><div className="font-display tracking-wide" style={{ fontSize: 26, color: "#fff" }}>CHALLENGE NOT FOUND</div><Link href="/draft" className="inline-block mt-4 font-body" style={{ color: "#00ff87" }}>← Draft XI</Link></div>);
    ...
    <div className="min-h-[100dvh] pb-28" style={{ background: "#0a0a0f" }}>
      <div className="max-w-lg mx-auto px-5 pt-safe">
        ...
        <div className="mt-5 space-y-3">
          ...
          <Link href="/draft" className="block w-full rounded-2xl py-3 text-center font-body active:scale-[0.98] transition-transform"
