...
/**
 * /draft/leaderboard — global Daily + All-time H2H win boards (the recurring
      ...
      <div className="max-w-lg mx-auto px-5 pt-safe">
        ...
        {loading ? (
          ...
          <div className="rounded-2xl p-6 text-center" style={{ background: "#12121e", border: "1px solid rgba(255,255,255,0.08)" }}>
            ...
            <Link href="/draft" className="inline-block mt-4 rounded-xl px-5 py-3 font-display tracking-wide"
