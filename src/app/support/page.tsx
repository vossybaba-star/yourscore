  ...
  return (
    <main className="min-h-dvh" style={{ background: "#0a0a0f", color: "#eef2f0" }}>
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <p className="font-body text-sm mb-10" style={{ color: "#8a948f" }}>
        ...
        >
          <p className="font-body text-sm mb-1" style={{ color: "#8a948f" }}>Contact</p>
          <a
        ...
        <div className="space-y-6 font-body text-sm leading-relaxed" style={{ color: "#c4ccc6" }}>
          {FAQ.map((item) => (
            <section key={item.q}>
