/**
 * Tiny deterministic RNG for the Quiz game types — self-contained so the game
 * types carry NO dependency on the (unshipped) fantasy gate engine. Same seed →
 * same round, so server-side grading reproduces the exact questions.
 */
