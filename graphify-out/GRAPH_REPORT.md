# Graph Report - ys-watch-build  (2026-06-09)

## Corpus Check
- 231 files · ~969,674 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1627 nodes · 3016 edges · 129 communities (111 shown, 18 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9a640944`
...
6. `slotsFor()` - 27 edges
7. `seededRng()` - 27 edges
8. `BottomNav()` - 26 edges
9. `PlacedPlayer` - 21 edges
10. `GridBackground()` - 20 edges
...
Cohesion: 0.06
Nodes (74): expired(), POST(), aggregate(), assistWeight(), botOf(), buildReport(), flipReport(), goalWeight() (+66 more)
...
Cohesion: 0.12
Nodes (20): AcceptChallenge(), Board, Incoming, LeagueBoard(), Member, DraftHeader(), TABS, useUser() (+12 more)
...
Cohesion: 0.05
Nodes (105): DraftHome(), Info, FORMATION_NOTE, FORMATION_SLOTS, GK, slotsFor(), applyBotSwaps(), bestOpenSlot() (+97 more)
...
Cohesion: 0.12
Nodes (30): POST(), POST(), DELETE(), PATCH(), leagueLiveStateFor(), createDraftDb(), genJoinCode(), SquadInput (+22 more)
...
Cohesion: 0.47
Nodes (3): Test, ExampleInstrumentedTest, Test

### Community 51 - "Community 51"
Cohesion: 0.47
Nodes (3): Test, ExampleUnitTest, Test
...
Cohesion: 0.10
Nodes (16): EmailMode, OAuthButton(), Provider, SignInWithGoogle(), JoinLeagueInner(), JoinLeaguePage(), LeagueTablePreview(), TableMember (+8 more)

### Community 85 - "Community 85"
Cohesion: 0.09
Nodes (12): MatchSim, PlayerRating, Side, bestOf(), halftimeView(), LiveMatchScreen(), PHASE_GUIDE, ReportView (+4 more)
...
## Knowledge Gaps
- **717 isolated node(s):** `extends`, `project_number`, `project_id`, `storage_bucket`, `config` (+712 more)
...
- **Why does `useUser()` connect `Community 21` to `Community 98`, `Community 11`, `Community 13`, `Community 15`, `Community 18`, `Community 84`, `Community 24`, `Community 28`, `Community 94`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `createServiceClient()` connect `Community 89` to `Community 1`, `Community 36`, `Community 81`, `Community 83`, `Community 20`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `BottomNav()` connect `Community 21` to `Community 97`, `Community 11`, `Community 13`, `Community 15`, `Community 16`, `Community 18`, `Community 84`, `Community 24`, `Community 28`, `Community 94`?**
