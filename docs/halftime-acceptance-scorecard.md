...
| 35 migration 80: RLS deny-all, PUBLIC revoke | ✅ | read directly; also strips table grants as defense-in-depth; CHECK constraints on state machine |
...
2. Apply `supabase/migrations/80_halftime.sql` to prod
