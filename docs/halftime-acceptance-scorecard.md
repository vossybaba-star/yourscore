...
| 35 migration 78: RLS deny-all, PUBLIC revoke | ✅ | read directly; also strips table grants as defense-in-depth; CHECK constraints on state machine |
...
2. Apply `supabase/migrations/78_halftime.sql` to prod
