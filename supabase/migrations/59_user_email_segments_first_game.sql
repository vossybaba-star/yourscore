-- Add "first game" to the segmentation context: what each user played FIRST
-- (their entry point when they signed up). Powers nostalgia win-backs —
-- "remember building your first XI?" / "the World Cup Mastermind you came for".
-- Appended to the end of the view (create-or-replace allows new trailing cols).
